...
# mae params
_C.MODEL.MAE_EMBED_DIM = 384
_C.MODEL.MAE_DECODER_EMBED_DIM = 256
_C.MODEL.MAE_NUM_PATCHES = 8
_C.MODEL.MAE_PATCH_SIZE = 4
_C.MODEL.MAE_DECODER_NUM_HEADS = 6
_C.MODEL.MAE_MLP_RATIO = 4
_C.MODEL.MAE_IN_CHANS = 3
_C.MODEL.MAE_DEPTH = 6
_C.MODEL.MAE_NUM_HEADS = 6

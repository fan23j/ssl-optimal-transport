...
class VisualTransformer(nn.Module):
    ...
    def train(self, mode=True):
        ...
        f_list = [
            self.patch_embed
        ]  ### provide the patch and seq_len to the main.py, not used in the training.
        if (
            self.freeze_conv1
        ):  ### freeze the conv1, copied from the DeCLIP codebase and we followed its default setting.
